...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <tr align="center" valign="middle">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div style="width: 90px; height: 60px;" class="clubitem"><?if ($room == 'km_1') echo $flag;?><strong>Зал воинов</strong> (<strong><?echo $char->info->roomOnline ('km_1', 'map');?></strong>)</div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr align="center" valign="middle">
    <td><div style="width: 90px; height: 60px;" class="clubitem"><?if ($room == 'km_4') echo $flag;?><strong>Будуар</strong> (<strong><?echo $char->info->roomOnline ('km_4', 'map');?></strong>)</div></td>
    <td><img src="img/icon/maparrh.gif" width="20" height="20" /></td>
    <td>
      <div style="width: 160px; height: 100px;" class="clubitem">
        <table cellpadding="0" cellspacing="0" width="100%" height="100%">
          <tr valign="top"><td align="center" style="font-size: 10px;"><?if ($room == 'castle') echo $flag;?><strong>Бойцовский Клуб</strong> (<strong><?echo $char->info->roomOnline ('castle', 'map');?></strong>)</td></tr>
          <tr valign="bottom"><td align="left" style="font-size: 10px;">Переходы:<br><strong>&nbsp;Центральная площадь<br>&nbsp;Этаж 2</strong></td></tr>
        </table>
      </div>
    </td>
    <td><img src="img/icon/maparrh.gif" width="20" height="20" /></td>
    <td><div style="width: 90px; height: 60px;" class="clubitem"><?if ($room == 'km_2') echo $flag;?><strong>Зал воинов 2</strong> (<strong><?echo $char->info->roomOnline ('km_2', 'map');?></strong>)</div></td>
    <td><img src="img/icon/maparrhl.gif" width="20" height="20" /></td>
    <td>
      <div style="width: 90px; height: 60px;" class="clubitem">
      <table cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr valign="top"><td align="center" style="font-size: 10px;"><?if ($room == 'Комната Перехода') echo $flag;?><strong>Комната Перехода</strong> (<strong><?echo $char->info->roomOnline ('Комната Перехода', 'map');?></strong>)</td></tr>
    ...
    <td>
      ...
      <table cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr valign="top"><td align="center" style="font-size: 10px;"><?if ($room == 'Комната для новичков') echo $flag;?><strong>Комната для новичков</strong> (<strong><?echo $char->info->roomOnline ('Комната для новичков', 'map');?></strong>)</td></tr>
  ...
  <tr align="center" valign="middle">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div style="width: 90px; height: 60px;" class="clubitem"><?if ($room == 'km_3') echo $flag;?><strong>Зал воинов 3</strong> (<strong><?echo $char->info->roomOnline ('km_3', 'map');?></strong>)</div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr align="center" valign="middle">
    <td><div style="width: 120px; height: 80px;" class="clubitem"><?if ($room == 'km_6') echo $flag;?><strong>Рыцарский зал</strong> (<strong><?echo $char->info->roomOnline ('km_6', 'map');?></strong>)</div></td>
  ...
  <tr align="center" valign="middle">
    <td>
      ...
      <table cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr valign="top"><td align="center" style="font-size: 10px;"><?if ($room == 'castle2') echo $flag;?><strong>Этаж 2</strong> (<strong><?echo $char->info->roomOnline ('castle2', 'map');?></strong>) </td></tr>
    ...
    <td><div style="width: 120px; height: 80px;" class="clubitem"><?if ($room == 'km_7') echo $flag;?><strong>Торговый Зал</strong> (<strong><?echo $char->info->roomOnline ('km_7', 'map');?></strong>)</div></td>
    <td><img src="http://img.combats.com/i/maparrh.gif" width="20" height="20" /></td>
