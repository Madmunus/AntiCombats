	...
	<tr>
		...
		<td align="center" width="50%" style="padding-left: 10px;">
			<table width="100%" border="0">
				...
				<tr>
					<td align="center"><input type="text" class="inup" align="middle" style="width: 144" value="Логин" name="login"></td>
				</tr>
				<tr>
					<td align="center">
				...
				<tr>
					<td height="19" align="center"><input type="submit" class="btn" value=" Войти " onclick="<?echo $login;?>"></td>
				</tr>
				<tr>
					<td align="center"><input type='button' class='btn' style='width: 120px;' value=' Регистрация ' onclick="<?echo $registration;?>"></td>
				</tr>
				</form>
			</table>
		</td>
