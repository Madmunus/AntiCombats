...
$on1 = 0;
	...
	if($login == $target){
		...
		$phrase = "<span class=date2>$date</span> <span class=$span>$login</span> Восстановил свое здоровье на <span class=hitted>$hp_add</span> пунктов!<BR>";
		...
		$phrase = "<span class=date>$date</span> <span class=$span>$login</span> Восстановил здоровье <span class=$span2>$target</span> на <span class=hitted>$hp_add</span> пунктов!<BR>";
