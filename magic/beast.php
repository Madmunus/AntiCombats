...
$bid = $db["battle"];
$SEEK_BOT = mysql_query("SELECT * FROM users WHERE login='Волк'");
...
$S = mysql_query("INSERT INTO bot_temp(bot_name,hp,hp_all,battle_id,prototype,team,mana,mana_all) VALUES('$bot_name','$bot_hp','$bot_hp','$bid','Волк','$team','$bot_mana','$bot_mana')");
