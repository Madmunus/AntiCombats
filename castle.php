...
$desc = $char->city->getRoom($room, $city, 'description');
...
?>
        ...
        <img id="passage" src="img/room/map_klub2.png" class="map_klub2" alt="<?echo $char->city->getRoomOnline('castle2');?>" onclick="<?echo $floor_2;?>" />
...
?>
        ...
        <img id="passage" src="img/room/map_zal3.png" class="map_zal3" alt="<?echo $char->city->getRoomOnline('perehod');?>" onclick="solo('perechod');" />
